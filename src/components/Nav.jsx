...
class NavBrand extends React.Component{
    ...
    render(){
        ...
        if (error) {
            ...
            return( 
                <span class="navbar-brand mb-0 h1 text-sm-start user-select-none">
                    <img src="https://www.kindpng.com/picc/m/238-2385924_monogram-letters-n-hd-png-download.png" alt="..." width="30" height="24" class="d-inline-block align-text-top"/>
                    Панель навигации
                </span>
            );
        }
        ...
        if (error) {
            ...
            return( 
                <li className="nav-item">
                    <a 
                        className="nav-link btn-primary user-select-none" 
                        href={link}
                        role="button"
                    >
                        {value}
